...
export default function ShopHeader() {
  ...
  return (
    <header
      className={`sticky top-0 z-50 w-full border-b transition-all duration-300 ${isScrolled ? "bg-white dark:bg-black shadow-md" : "bg-white dark:bg-black"
        }`}
    >
