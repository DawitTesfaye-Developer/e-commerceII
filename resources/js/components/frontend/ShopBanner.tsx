...
export default function ShopBanner(): JSX.Element {
  ...
  return (
    <section
      className="relative w-full overflow-hidden h-screen max-h-[400px] min-h-[100px] border-2 border-gray-300 shadow rounded-2xl mt-8"
              ...
              <div className="container mx-auto h-full flex items-center px-4 md:px-8">
                ...
                >
                  <div className="backdrop-blur-sm bg-white/30 p-6 md:p-8 lg:p-10 rounded-2xl shadow-xl border border-white/50">
                    ...
                    {/* Title */}
                    <h2
                      className={`mb-4 text-3xl leading-tight font-bold md:text-4xl ${slide.textColor}`}
                    >
                      {slide.title}
                    </h2>
